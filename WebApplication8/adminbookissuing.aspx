				...
				<div class="card">
					<div class="card-body">
						...
						<br />
							<div class="row">
								<div class="col-6">
									<asp:Button ID="Button2" class="btn btn-lg w-100 btn-primary" runat="server" Text="Issue" OnClick="Button2_Click" />
								</div>
								<div class="col-6">
									<asp:Button ID="Button4" class="btn btn-lg w-100 btn-success" runat="server" Text="Return" OnClick="Button4_Click" />
								</div>
							</div>
						</div>
					</div>
