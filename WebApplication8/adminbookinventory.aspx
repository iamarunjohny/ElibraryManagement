            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="50px" src="imgs/books.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col-4">
                        <asp:Button ID="Button1" class="btn  w-100 btn-success" runat="server" Text="Add" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button3" class="btn w-100  btn-warning" runat="server" Text="Update" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button2" class="btn w-100 btn-danger" runat="server" Text="Delete" />
                     </div>
                  </div>
               </div>
            </div>
